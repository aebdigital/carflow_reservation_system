...
const reservationSchema = new mongoose.Schema({
  ...
  status: {
    type: String,
    enum: ['pending', 'awaiting_payment', 'confirmed', 'zaplatene', 'ongoing', 'completed', 'cancelled', 'no-show'],
    default: 'pending'
  },
  pricing: {
    dailyRate: {
  ...
  // generation time and editable through the invoice editor (items array).
  invoice: {
